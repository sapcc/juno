...
const Template = (args) => <Stack className={docuClassnames(args.direction)} {...args}><DummyComponentList count={5} /></Stack>
const TemplateManyChildren = (args) => <Stack className="bg-theme-background-lvl-3" {...args}><DummyComponentList count={15} /></Stack>
...
VerticalAlignmentCenter.parameters = {
  docs: {
    description: { story: "The same as above is true for vertical Stacks. But in this case the alignment property controls the alignment along the horizontal axis. By default items are stretched to the full width. Using 'center' alignment causes the items to be aligned around the central axis."}
  },
}
...
HorizontalAlignmentStart.parameters = {
  docs: {
    description: { story: "Setting the alignment to 'start' will cause the items to be aligned to the top in a horizontal Stack."}
  },
}
...
VerticalAlignmentStart.parameters = {
  docs: {
    description: { story: "Setting the alignment to 'start' will cause the items to be aligned to the left in a vertical Stack."}
  },
}
...
HorizontalDistributionCenter.parameters = {
  docs: {
    description: { story: "The distribution along the horizontal axis in a horizontal Stack can be controlled via the 'distribution' property. Setting it to 'center' will cause the items to be aligned to the center of the horizontal axis."}
  },
}
...
VerticalDistributionCenter.parameters = {
  docs: {
    description: { story: "Setting the distribution to 'center' in a vertical Stack will cause the items to be aligned to the center of the vertical axis."}
  },
}
...
Centered.parameters = {
  docs: {
    description: { story: "To center a Stack's children both horizontally and vertically at the same time simple set both the alignment and distribution props to 'center'. This works for horizontal and vertical Stacks."}
  },
}
Centered.args = {
  alignment: "center",
...
Wrap.parameters = {
  docs: {
    description: { story: "If there are too many children to fit in the available horizontal space, set the 'wrap' property to true to allow children to wrap to the next row (also works for vertical Stacks with restricted height)."}
  },
}
Wrap.args = {
  wrap: true,
