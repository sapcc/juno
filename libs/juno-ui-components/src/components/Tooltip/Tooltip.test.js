...
describe("Tooltip", () => {
  ...
  test("renders a plain tooltip popover without an icon by default", async () => {
    ...
    await userEvent.click(screen.getByRole("button"))
    expect(
      document.querySelector("juno-tooltip-popover-icon")
  ...
  test("renders an Info Tooltip as passed", async () => {
    ...
    await userEvent.click(screen.getByRole("button"))
    expect(
      document.querySelector(".juno-tooltip-popover-info")
    ).toBeInTheDocument()
  ...
  test("renders a Warning Tooltip as passed", async () => {
    ...
    await userEvent.click(screen.getByRole("button"))
    expect(
      document.querySelector(".juno-tooltip-popover-warning")
    ).toBeInTheDocument()
  ...
  test("renders an Error Tooltip as passed", async () => {
    ...
    await userEvent.click(screen.getByRole("button"))
    expect(
      document.querySelector(".juno-tooltip-popover-error")
    ).toBeInTheDocument()
  ...
  test("renders a Danger Tooltip as passed", async () => {
    ...
    await userEvent.click(screen.getByRole("button"))
    expect(
      document.querySelector(".juno-tooltip-popover-danger")
    ).toBeInTheDocument()
