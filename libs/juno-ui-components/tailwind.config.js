  ...
  theme: {
    ...
    extend: {
      ...
      width: {
        ...
        "grid-col-2": "calc(16.666667% - var(--grid-gutter-column))",
        "grid-col-3": "calc(25% - 2 * var(--grid-gutter-column))",
        "grid-col-4": "calc(33.33333333% - 3 * var(--grid-gutter-column))",
        "grid-col-5": "calc(41.666667% - 4 * var(--grid-gutter-column))",
        "grid-col-6": "calc(50% - 5 * var(--grid-gutter-column))",
        "grid-col-7": "calc(58.333333% - 6 * var(--grid-gutter-column))",
        "grid-col-8": "calc(66.666667% - 7 * var(--grid-gutter-column))",
        "grid-col-9": "calc(75% - 8 * var(--grid-gutter-column))",
        "grid-col-10": "calc(83.33333333% - 9 * var(--grid-gutter-column))",
        "grid-col-11": "calc(91.666667% - 10 * var(--grid-gutter-column))",
        "grid-col-12": "100%",
      },
      borderRadius: {
        "3px": "3px",
