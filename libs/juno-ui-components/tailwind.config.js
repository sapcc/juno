...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      "sap-blue": {
        1: withOpacity("--color-sap-blue-light-raw"),
        2: withOpacity("--color-sap-blue-light-1-raw"),
        3: withOpacity("--color-sap-blue-light-2-raw"),
        4: withOpacity("--color-sap-blue-light-3-raw"),
        5: withOpacity("--color-sap-blue-raw"),
        6: withOpacity("--color-sap-blue-dark-1-raw"),
        7: withOpacity("--color-sap-blue-dark-raw"),
