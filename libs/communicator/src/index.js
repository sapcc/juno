...
//       channelName += "#" + window.__juno_communicator_tab_id
//     }
...
//       bc.onmessage = (e) => {
//         console.log(window.__juno_communicator_tab_id, "RECEIVE ON WATCH", e)
//         callback(e.data)
//       }
//     }

//     // listen ever for intra-window messages
//     const bcIntra = new BroadcastChannel(
//       CHANNEL_PREFIX + name + "#" + window.__juno_communicator_tab_id
//     )
...
//       { crossWindow }
//     )
//     broadcast(requesterID, { receiverID, getOptions }, { crossWindow })
//     return unwatch
//   } catch (e) {
//     error(e.message)
//   }
...
//         broadcast(data.receiverID, callback(), { crossWindow })
//       },
//       { crossWindow }
//     )
