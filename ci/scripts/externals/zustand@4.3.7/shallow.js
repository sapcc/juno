...
var require_shallow = __commonJS({
  "../../../tmp/node_modules/zustand/shallow.js"(exports, module) {
    ...
    __name(shallow2, "shallow");
    var shallow$1 = /* @__PURE__ */ __name(function(objA, objB) {
      if (true) {
        console.warn("[DEPRECATED] Default export is deprecated. Instead use `import { shallow } from 'zustand/shallow'`.");
      }
      return shallow2(objA, objB);
    }, "shallow$1");
    exports.default = shallow$1;
    exports.shallow = shallow2;
    module.exports = shallow$1;
    module.exports.shallow = shallow2;
