...
/**
   ...
   * @type {string}
   */static set defaultZone(e){W=e}
/**
   * Get the default time zone object currently used to create DateTimes. Does not affect existing instances.
   * The default value is the system's time zone (the one set on the machine that runs this code).
   * @type {Zone}
   */static get defaultZone(){return normalizeZone(W,SystemZone.instance)}
/**
...
/**
   ...
   * @type {string}
   */static get defaultNumberingSystem(){return _}
/**
   * Set the default numbering system to create DateTimes with. Does not affect existing instances.
   * @type {string}
   */static set defaultNumberingSystem(e){_=e}
/**
...
/**
   ...
   * @param {string} [opts.conversionAccuracy='casual'] - the conversion system to use
   * @return {Duration}
   */static fromObject(e,t={}){if(null==e||"object"!==typeof e)throw new InvalidArgumentError("Duration.fromObject: argument expected to be an object, got "+(null===e?"null":typeof e));return new Duration({values:normalizeObject(e,Duration.normalizeUnit),loc:Locale.fromObject(t),conversionAccuracy:t.conversionAccuracy})}
/**
...
/**
   ...
   * @return {Duration}
   */plus(e){if(!this.isValid)return this;const t=Duration.fromDurationLike(e),n={};for(const e of Ue)(hasOwnProperty(t.values,e)||hasOwnProperty(this.values,e))&&(n[e]=t.get(e)+this.get(e));return clone$1(this,{values:n},true)}
/**
...
/**
   ...
   * @return {Duration}
   */set(e){if(!this.isValid)return this;const t={...this.values,...normalizeObject(e,Duration.normalizeUnit)};return clone$1(this,{values:t})}reconfigure({locale:e,numberingSystem:t,conversionAccuracy:n}={}){const r=this.loc.clone({locale:e,numberingSystem:t}),s={loc:r};n&&(s.conversionAccuracy=n);return clone$1(this,s)}
/**
   ...
   * @return {number}
   */as(e){return this.isValid?this.shiftTo(e).get(e):NaN}normalize(){if(!this.isValid)return this;const e=this.toObject();normalizeValues(this.matrix,e);return clone$1(this,{values:e},true)}shiftTo(...e){if(!this.isValid)return this;if(0===e.length)return this;e=e.map((e=>Duration.normalizeUnit(e)));const t={},n={},r=this.toObject();let s;for(const i of Ue)if(e.indexOf(i)>=0){s=i;let e=0;for(const t in n){e+=this.matrix[t][i]*n[t];n[t]=0}isNumber(r[i])&&(e+=r[i]);const a=Math.trunc(e);t[i]=a;n[i]=(1e3*e-1e3*a)/1e3;for(const e in r)Ue.indexOf(e)>Ue.indexOf(i)&&convert(this.matrix,r,e,t,i)}else isNumber(r[i])&&(n[i]=r[i]);for(const e in n)0!==n[e]&&(t[s]+=e===s?n[e]:n[e]/this.matrix[s][e]);return clone$1(this,{values:t},true).normalize()}negate(){if(!this.isValid)return this;const e={};for(const t of Object.keys(this.values))e[t]=0===this.values[t]?0:-this.values[t];return clone$1(this,{values:e},true)}
/**
   * Get the years.
   * @type {number}
...
/**
   ...
   * @return {boolean}
   */equals(e){if(!this.isValid||!e.isValid)return false;if(!this.loc.equals(e.loc))return false;function eq(e,t){return void 0===e||0===e?void 0===t||0===t:e===t}for(const t of Ue)if(!eq(this.values[t],e.values[t]))return false;return true}}const $e="Invalid Interval";function validateStartEnd(e,t){return e&&e.isValid?t&&t.isValid?t<e?Interval.invalid("end before start",`The end of an interval must be after its start, but you had start=${e.toISO()} and end=${t.toISO()}`):null:Interval.invalid("missing or invalid end"):Interval.invalid("missing or invalid start")}class Interval{constructor(e){this.s=e.start;this.e=e.end;this.invalid=e.invalid||null;this.isLuxonInterval=true}
/**
...
/**
   ...
   * @return {number}
   */count(e="milliseconds"){if(!this.isValid)return NaN;const t=this.start.startOf(e),n=this.end.startOf(e);return Math.floor(n.diff(t,e).get(e))+1}
/**
...
/**
   ...
   * @return {Array}
   */difference(...e){return Interval.xor([this].concat(e)).map((e=>this.intersection(e))).filter((e=>e&&!e.isEmpty()))}toString(){return this.isValid?`[${this.s.toISO()} – ${this.e.toISO()})`:$e}
/**
   * Returns an ISO 8601-compliant string representation of this Interval.
   * @see https://en.wikipedia.org/wiki/ISO_8601#Time_intervals
   * @param {Object} opts - The same options as {@link DateTime#toISO}
   * @return {string}
   */toISO(e){return this.isValid?`${this.s.toISO(e)}/${this.e.toISO(e)}`:$e}toISODate(){return this.isValid?`${this.s.toISODate()}/${this.e.toISODate()}`:$e}
/**
   ...
   * @param {Object} opts - The same options as {@link DateTime#toISO}
   * @return {string}
   */toISOTime(e){return this.isValid?`${this.s.toISOTime(e)}/${this.e.toISOTime(e)}`:$e}
/**
   ...
   * @return {string}
   */toFormat(e,{separator:t=" – "}={}){return this.isValid?`${this.s.toFormat(e)}${t}${this.e.toFormat(e)}`:$e}
/**
...
/**
   ...
   * @param {string} options.numberingSystem - the numbering system to set on the resulting DateTime instance
   * @return {DateTime}
   */static fromMillis(e,t={}){if(isNumber(e))return e<-Qe||e>Qe?DateTime.invalid("Timestamp out of range"):new DateTime({ts:e,zone:normalizeZone(t.zone,Settings.defaultZone),loc:Locale.fromObject(t)});throw new InvalidArgumentError(`fromMillis requires a numerical input, but received a ${typeof e} with value ${e}`)}
/**
...
/**
   ...
   * @return {DateTime}
   */static fromObject(e,t={}){e=e||{};const n=normalizeZone(t.zone,Settings.defaultZone);if(!n.isValid)return DateTime.invalid(unsupportedZone(n));const r=Settings.now(),s=isUndefined(t.specificOffset)?n.offset(r):t.specificOffset,i=normalizeObject(e,normalizeUnit),a=!isUndefined(i.ordinal),o=!isUndefined(i.year),u=!isUndefined(i.month)||!isUndefined(i.day),l=o||u,c=i.weekYear||i.weekNumber,d=Locale.fromObject(t);if((l||a)&&c)throw new ConflictingSpecificationError("Can't mix weekYear/weekNumber units with year/month/day or ordinals");if(u&&a)throw new ConflictingSpecificationError("Can't mix ordinal dates with month/day");const m=c||i.weekday&&!l;let h,f,y=tsToObj(r,s);if(m){h=nt;f=Xe;y=gregorianToWeek(y)}else if(a){h=rt;f=et;y=gregorianToOrdinal(y)}else{h=tt;f=Ke}let g=false;for(const e of h){const t=i[e];isUndefined(t)?i[e]=g?f[e]:y[e]:g=true}const p=m?hasInvalidWeekData(i):a?hasInvalidOrdinalData(i):hasInvalidGregorianData(i),T=p||hasInvalidTimeData(i);if(T)return DateTime.invalid(T);const w=m?weekToGregorian(i):a?ordinalToGregorian(i):i,[O,S]=objToTS(w,s,n),D=new DateTime({ts:O,zone:n,o:S,loc:d});return i.weekday&&l&&e.weekday!==D.weekday?DateTime.invalid("mismatched weekday",`you can't specify both a weekday of ${i.weekday} and a date of ${D.toISO()}`):D}
/**
...
/**
   ...
   * @return {string}
   */
toFormat(e,t={}){return this.isValid?Formatter.create(this.loc.redefaultToEN(t)).formatDateTimeFromString(this,e):Be}
/**
   ...
   * @return {string}
   */toLocaleString(e=r,t={}){return this.isValid?Formatter.create(this.loc.clone(t),e).formatDateTime(this):Be}
/**
