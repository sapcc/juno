...
import UmbrellaIcon from "../../images/icon_umbrella.svg"
import AWSLogo from "../../images/AWS_logo.svg"
import AzureLogo from "../../images/Microsoft_Azure_logo.svg"
import CCShortLogo from "../../images/CCplusOne_short_logo.svg"

import { H4, FlexContainer } from "../shared/StyledComponents"
import { getBgColorStyle, getTextColorStyle } from "../../styles/StyleMap"
      ...
      <CostComparison>
        <ProgressContainer>
          ...
          <Progress>
            ...
            <IndicatorText style={{ right: "70%" }}>
              1,632 &euro;*
            </IndicatorText>
            <IndicatorText style={{ right: "12%" }} color="black">
              4,497 &euro;*
            </IndicatorText>
            <IndicatorText style={{ right: "0" }} color="black">
              4,960 &euro;*
            </IndicatorText>
          ...
          <ProgressFootnote>
            <div>
              Configuration: Big Data example, 2500GB internet data traffic
            </div>
